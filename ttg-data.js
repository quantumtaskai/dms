// TTG Data processing utilities for new CSV data
class TTGDashboardData {
    constructor() {
        this.platforms = [];
        this.hashtags = [];
        this.competitors = [];
    ...
    // Parse CSV data from the new TTG file
    async loadData() {
    ...
    processAnalytics() {
        ...
        // Calculate content metrics - Updated totals from TTG CSV
    ...
    formatContentLink(contentCreated, platformName) {
        ...
        if (contentCreated === 'Link') {
            return `<span class="content-placeholder">📝 Content Link</span>`;
        }
...
// Initialize TTG data instance
const ttgDashboardData = new TTGDashboardData();
ttgDashboardData.loadData();